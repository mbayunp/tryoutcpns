...
CREATE TABLE IF NOT EXISTS `tryouts` (
  ...
  `program_type` ENUM('PPG', 'PPPK', 'SKD') NOT NULL DEFAULT 'SKD',
  `product_type` ENUM('TRYOUT', 'KELAS', 'EBOOK', 'BUNDLE') NOT NULL DEFAULT 'TRYOUT',
  `wa_group_link` VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `options_weights` JSON DEFAULT NULL,
